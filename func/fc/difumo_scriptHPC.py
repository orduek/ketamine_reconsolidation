...
func_template = '/gpfs/gibbs/pi/levy_ifat/Or/kpe/fmriprep/sub-{sub}/ses-{session}/func/sub-{sub}_ses-{session}_task-Memory_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz'
confound_template = '/gpfs/gibbs/pi/levy_ifat/Or/kpe/fmriprep/sub-{sub}/ses-{session}/func/sub-{sub}_ses-{session}_task-Memory_desc-confounds_regressors.tsv'
...
for sub in subject_list:
    ...
    try:
        ...
        print(f'Subject {subject} does not have files')
